...
export async function handleContextGet(args: unknown): Promise<CallToolResult> {
...
export async function handleContextUpdate(args: unknown): Promise<CallToolResult> {
