...
import type {
  Tool,
  CallToolResult,
  AutoLearnDecisionArgs,
  AutoLearnFixArgs,
  AutoLearnPatternArgs,
  AutoLearnDependencyArgs
} from '../types.js';
...
export async function autoLearnDecision(args: AutoLearnDecisionArgs): Promise<CallToolResult> {
  try {
...
export async function autoLearnFix(args: AutoLearnFixArgs): Promise<CallToolResult> {
  try {
...
export async function autoLearnPattern(args: AutoLearnPatternArgs): Promise<CallToolResult> {
  try {
...
export async function autoLearnDependency(args: AutoLearnDependencyArgs): Promise<CallToolResult> {
  try {
