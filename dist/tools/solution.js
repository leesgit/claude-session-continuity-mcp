...
// ===== 핸들러 =====
export function recordSolution(errorSignature, solution, project, errorMessage, relatedFiles) {
    try {
        // 키워드 자동 추출
...
export function findSolution(errorText, project) {
    try {
        // 키워드 추출
...
export function getContinuityStats(project) {
    try {
        const stats = {};
        // 프로젝트 컨텍스트 통계
        if (project) {
